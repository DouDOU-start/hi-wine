...
// FileProxyPublic 公共文件代理，通过服务端访问MinIO中的文件
func (c *ControllerV1) FileProxyPublic(ctx context.Context, req *v1.FileProxyReq) (res *ghttp.Response, err error) {
	// 获取MinIO客户端
	...
	g.Log().Debug(ctx, "公共文件代理请求路径: ", path, ", 存储桶: ", bucketName)
